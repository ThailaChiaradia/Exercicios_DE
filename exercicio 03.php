...
usort($arrayDeClientes, function($x, $y) 
{
	$a = DateTime::createFromFormat('d-m-Y', $x->nascimento);
    $b = DateTime::createFromFormat('d-m-Y', $y->nascimento);
    return $a <=> $b;
});
